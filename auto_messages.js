...
class RocketChatAutomation {
    ...
    async getRoomIdByName(roomName) {
        try {
            ...
            // The API returns rooms under "update" or "rooms", depending on version.
            const rooms = response.data.update || response.data.rooms || [];
    ...
    async startDailyMessageScheduler(time = '08:00') {
        ...
        this.scheduledTask = cron.schedule(`${minute} ${hour} * * *`, async () => {
